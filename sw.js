const CACHE='open-days-v1.6.0';
const ASSETS=[
  './','./index.html','./styles.css','./app.js','./integrations.js','./version.json',
  './plugins/app-platform.js','./plugins/autosave.js','./plugins/firebase-token-sync.js','./plugins/developer-notes.js','./plugins/version-lab.js','./plugins/personal-updates.js',
