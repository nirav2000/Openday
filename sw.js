const CACHE='open-days-v4';const ASSETS=['./','./index.html','./styles.css','./app.js','./hotfix.js','./data/schools.json','./data/enhancements.json','./calendar.ics','./manifest.webmanifest','./icon.svg'];
